        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="space-y-2">
            ...
            <p className="text-gray-400 text-sm sm:text-base">
              {planName ? `Deposit USDT to activate your ${planName} investment plan` : 'Add USDT to your wallet to start earning crypto returns'}
            </p>
          </div>
          <div className="flex items-center space-x-2 bg-gradient-to-r from-green-500/20 to-blue-500/20 backdrop-blur-sm border border-green-500/30 px-4 py-2 rounded-full">
            ...
            <span className="text-sm font-medium text-green-300">Instant Blockchain Processing</span>
          </div>
        </div>
              ...
              <CardHeader>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-gray-400">Enter the amount you want to invest in USDT TRC20</CardDescription>
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">Instant blockchain confirmation</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-400" />
                    <div>
                      <div className="font-medium text-white">Network Fees</div>
                      <div className="text-sm text-gray-400">Covered by platform</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-400" />
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-300">Real-time Blockchain Processing</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <CheckCircle className="h-4 w-4 text-green-400" />
              ...
              <CardContent className="p-4">
                <div className="text-center space-y-3">
                  ...
                  <div className="text-xs text-orange-200">
                    Our crypto support team is available 24/7 to assist with your USDT deposit.
                  </div>
