-- ===============================================
-- WeEarn Mining Platform - Ultra Safe Production Setup
-- ===============================================
-- This script handles ALL foreign key constraints safely
...
-- 3. SAFELY DELETE ALL EXISTING DATA (Handle all foreign keys)
-- Delete in correct order to avoid foreign key violations

-- Delete subscriptions first (references both users and plans)
DELETE FROM subscriptions;

-- Delete transactions (references users)
DELETE FROM transactions;

-- Delete withdrawals (references users)
DELETE FROM withdrawals;

-- Delete deposits (references users) 
DELETE FROM deposits;

-- Delete referrals (references users)
DELETE FROM referrals;

-- Delete ALL plans (references categories)
DELETE FROM plans;

-- Now safe to delete categories
DELETE FROM plan_categories;

-- Delete user profiles (but keep auth users)
...
-- 5. CREATE PLAN CATEGORIES TABLE
...
-- 8. INSERT PLAN CATEGORIES (Fresh start)
...
-- 9. INSERT MINING PLANS (Fresh start)
INSERT INTO plans (
...
-- 13. VERIFICATION
SELECT 
    'Ultra Safe Production Setup Complete!' as status,
