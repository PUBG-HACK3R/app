-- ===============================================
-- WeEarn Database Reset for Bitcoin Mining System (SAFE VERSION)
-- ===============================================
-- WARNING: This will delete ALL existing data!
-- This version safely handles tables that may not exist
...
-- ===============================================
-- 2. CREATE PLAN CATEGORIES TABLE IF NOT EXISTS
-- ===============================================
...
-- ===============================================
-- 3. CREATE PLANS TABLE IF NOT EXISTS
-- ===============================================
...
-- ===============================================
-- 4. INSERT NEW MINING PLAN CATEGORIES
-- ===============================================
...
-- ===============================================
-- 5. INSERT NEW BITCOIN MINING PLANS
-- ===============================================
...
-- ===============================================
-- 6. CREATE SYSTEM SETTINGS TABLE AND INSERT DATA
-- ===============================================
...
SELECT 'WeEarn Mining Platform Database Setup Complete!' as final_status;
